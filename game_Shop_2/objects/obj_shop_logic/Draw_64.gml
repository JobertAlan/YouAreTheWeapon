...
draw_text(10, 10, "Coins: " + string(global.coin)); // Draw text at (10, 10)
...
draw_text(menuMargin +menuWidth + 4, guiHeight/14, "Coins: " + string(global.coin));
...
draw_set_valign(fa_bottom);
	...
	draw_set_halign(fa_right);
		draw_text(guiWidth - 4, guiHeight - 4, "Press Enter to purchase " + string(item));
	draw_set_halign(fa_left);
draw_set_valign(fa_top);
