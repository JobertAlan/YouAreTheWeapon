...
switch (global.enemyTurn) {
	...
	switch (global.enemyNextMove) {
            ...
            case 1: // Do an attack
                global_basic_attack(global.bossDmg, global.enemyTurn)
            break;
			
			case 2: //heavy 
				global_heavy_atk(global.bossDmg * 1.5, global.enemyTurn)
				break;
			case 3: //heal
				global_add_health(global.bossHp, global.enemyTurn)
			break;
